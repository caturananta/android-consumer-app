package co.id.dicoding.consumerapp.entity;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import co.id.dicoding.consumerapp.db.DatabaseContract;

import static android.provider.BaseColumns._ID;
import static co.id.dicoding.consumerapp.db.DatabaseContract.getColumnInt;
import static co.id.dicoding.consumerapp.db.DatabaseContract.getColumnString;
